twittyApp.controller('UnshownController', function UnshownController($scope, $timeout, $q, $http, $cookies, $location, $anchorScroll) {
    $scope.items = [];
    $scope.busy = false;
        ...
        $http({
            ...
            if (data != "") {
                ...
                for (var i = 0; i < items.length; i++) {
                    if (items[i].IdStr == $cookies.get("lastReadedTweetId")) {
                        flag = false;
                        return;
                    }
